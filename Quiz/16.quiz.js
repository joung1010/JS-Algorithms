...
function solution(n, arr1, arr2) {
    ...
    for (let i = 0; i < n; i++) {
        ...
        const binary = (union).toString(2);
        const makeBlank = ' '.repeat(n - binary.length);
        res.push(makeBlank+binary.replaceAll('0', ' ').replaceAll('1', '#'));
    }
    return res;
}
...
console.log((10).toString(2)); // Integer to Binary
